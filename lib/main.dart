...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void showFullScreenNotification() async {
    ...
    AndroidNotificationDetails(
        ...
        autoCancel: false,     // Prevents auto-cancellation
    ...
    await flutterLocalNotificationsPlugin.show(
        0, 'Incoming Call', 'You have an incoming call', platformChannelSpecifics,
  ...
  void onSelectNotification(NotificationResponse response) async {
    if (response.payload != null) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => AlarmScreen(flutterLocalNotificationsPlugin: flutterLocalNotificationsPlugin)),
      );
    }
  }
...
class AlarmScreen extends StatelessWidget {
  ...
  AlarmScreen({required this.flutterLocalNotificationsPlugin});
        ...
        children: [
          ...
          Positioned(
            ...
            child: AnimatedButton(
              ...
              color: Colors.red,
              onTap: () {
                // Handle reject call and dismiss notification
          ...
          Positioned(
            ...
            child: AnimatedButton(
              ...
              color: Colors.green,
              onTap: () {
                // Handle accept call (you can add your logic here)
                Navigator.pop(context);
              },
            ),
          ),
